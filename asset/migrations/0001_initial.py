    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', models.CharField(choices=[('葛卢菁', 'glj'), ('其他', '其他')], max_length=128, verbose_name='负责人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('private_key', models.FileField(blank=True, null=True, upload_to='upload/privatekey/%Y%m%d87620', verbose_name='私钥')),
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='asset.AssetLoginUser', verbose_name='登录用户'),
        ),
    ]
